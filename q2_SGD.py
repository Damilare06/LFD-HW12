...
class neural_net:
  def __init__(self, dataset, iters, m, value, output_actvn, perturb):
    self.m = m
    batch_size = 10
    ...
    self.plot_decision_boundary(iters, loss_history)
...
if __name__ == "__main__":
  ...
  perturb = False # perturb weights for question 1b

  # Y values are the first index of the dataset 
  neural_net(data_set, iters, m, 0.25, "linear", perturb)
